...
public class FSWatcherEngineEventTest : IDisposable
{
    ...
    private readonly ScriptBlock SpyOnEventCollection = ScriptBlock.Create("$global:result_collection += ($event|ConvertTo-Json -Depth 5)");
    ...
    private void ArrangeEngineEventWithCollection()
    {
        this.PowerShell.Commands.Clear();
        this.PowerShell
            .AddScript("$global:result_collection = @()")
            .Invoke();
        this.PowerShell.Commands.Clear();
        this.PowerShell
            .AddCommand("Register-EngineEvent")
            .AddParameter("SourceIdentifier", this.sourceIdentifier)
            .AddParameter("Action", this.SpyOnEventCollection)
            .Invoke();
    }
    ...
    private Collection<PSObject> ReadResultCollection()
    {
        this.PowerShell.Commands.Clear();
        return this.PowerShell
            .AddCommand("Get-Variable")
            .AddParameter("Name", "result_collection")
            .Invoke();
    }
